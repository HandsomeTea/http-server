...
//     /**
//      * @api {post} /api/iflytekadm/v1/administrator 新建管理员用户
//      * @apiGroup 管理员账户
//      * @apiVersion 1.0.0
...
//     }))
//     /**
//      * @api {get} /api/iflytekadm/v1/administrator 管理员用户分页查询
//      * @apiGroup 管理员账户
//      * @apiVersion 1.0.0
...
// })
//     /**
//      * @api {delete} /api/iflytekadm/v1/administrator/:account 管理员删除
//      * @apiGroup 管理员账户
//      * @apiVersion 1.0.0
...
//     }))
//     /**
//      * @api {put} /api/iflytekadm/v1/administrator/:account 管理员修改
//      * @apiGroup 管理员账户
//      * @apiVersion 1.0.0
//      * @apiParam (params) {String} account 管理员账户
//      * @apiParam (body) {string} [name] 姓名
...
//     }))
//     /**
//      * @api {get} /api/iflytekadm/v1/administrator/:account 管理员详情查询
//      * @apiGroup 管理员账户
//      * @apiVersion 1.0.0
//      * @apiParam (params) {String} account 管理员账户
//      */
